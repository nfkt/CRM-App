    ...
    <div>
      ...
      <Form onSubmit={handleSubmit} className="add-courses">
        ...
        <Form.Group className="mb-3" >
          ...
          <Form.Control type="number" min='1000' max='100000' required placeholder="Enter course fee" name="coursefee" value={courses.coursefee || ""} onChange={handleChange} onInvalid={(e) => { e.target.setCustomValidity('Enter fee for the course') }} onInput={(e) => { e.target.setCustomValidity('') }} />
        </Form.Group>
